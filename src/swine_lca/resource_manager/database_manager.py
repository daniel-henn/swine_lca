...
import pandas as pd
from swine_lca.database import get_local_dir
import os
...
class DataManager:
    ...
    Methods:
        data_engine_creater(): Initializes and returns a SQLAlchemy engine connected to the local sheep LCA database.
    ...
    def data_engine_creater(self):
        ...
        database_path = os.path.abspath(
            os.path.join(self.database_dir, "swine_database.db")
        )
    ...
    def emissions_factor_data(self, index=None):
        ...
        """        
        table = "swine_emissions_factors_database"
    ...
    def animal_features_data(self, index=None):
        ...
        """        
        table = "swine_animal_features_database"
