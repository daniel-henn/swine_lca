...
class LCADataManager:
    ...
    def __init__(self, ef_country):
        ...
        self.cohorts_data = {
            "boars": {
                "gender": "male",
                "Gross_energy": self.loader_class.emissions_factors.get_ef_Gross_energy_boars(),
                "N_excretion": self.loader_class.emissions_factors.get_ef_N_excretion_boars(),
                "bwf": self.loader_class.animal_features.get_weight_boars,
            ...
            "gilts_in_pig": {
                "gender": "female",
                "Gross_energy": self.loader_class.emissions_factors.get_ef_Gross_energy_gilts_in_pig(),
                "N_excretion": self.loader_class.emissions_factors.get_ef_N_excretion_gilts_in_pig(),
                "bwf": self.loader_class.animal_features.get_weight_gilts_in_pig,
                "total_ammonia_nitrogen": self.loader_class.emissions_factors.get_ef_fracGASM_total_ammonia_nitrogen_pasture_range_paddock_deposition,
                "direct_n2o": self.loader_class.emissions_factors.get_ef3__cpp_pasture_range_paddock_sheep_direct_n2o,
                "atmospheric_deposition": self.loader_class.emissions_factors.get_ef_indirect_n2o_atmospheric_deposition_to_soils_and_water,
                "leaching": self.loader_class.emissions_factors.get_ef_indirect_n2o_from_leaching_and_runoff,
            ...
            "sows_in_pig": {
                "gender": "female",
                "Gross_energy": self.loader_class.emissions_factors.get_ef_Gross_energy_sows_in_pig(),
                "N_excretion": self.loader_class.emissions_factors.get_ef_N_excretion_sows_in_pig(),
                "bwf": self.loader_class.animal_features.get_weight_sows_in_pig,
                "total_ammonia_nitrogen": self.loader_class.emissions_factors.get_ef_fracGASM_total_ammonia_nitrogen_pasture_range_paddock_deposition,
                "direct_n2o": self.loader_class.emissions_factors.get_ef3__cpp_pasture_range_paddock_sheep_direct_n2o,
                "atmospheric_deposition": self.loader_class.emissions_factors.get_ef_indirect_n2o_atmospheric_deposition_to_soils_and_water,
                "leaching": self.loader_class.emissions_factors.get_ef_indirect_n2o_from_leaching_and_runoff,
            ...
            "pigs_over_20kg": {
                "gender": "male",
                "Gross_energy": self.loader_class.emissions_factors.get_ef_Gross_energy_pigs_over_20kg(),
                "N_excretion": self.loader_class.emissions_factors.get_ef_N_excretion_pigs_over_20kg(),
                "bwf": self.loader_class.animal_features.get_weight_pigs_over_20kg,
                "total_ammonia_nitrogen": self.loader_class.emissions_factors.get_ef_fracGASM_total_ammonia_nitrogen_pasture_range_paddock_deposition,
                "direct_n2o": self.loader_class.emissions_factors.get_ef3__cpp_pasture_range_paddock_sheep_direct_n2o,
                "atmospheric_deposition": self.loader_class.emissions_factors.get_ef_indirect_n2o_atmospheric_deposition_to_soils_and_water,
                "leaching": self.loader_class.emissions_factors.get_ef_indirect_n2o_from_leaching_and_runoff,
            ...
            "gilts_not_yet_served": {
                "gender":"female",
                "Gross_energy": self.loader_class.emissions_factors.get_ef_Gross_energy_gilts_not_yet_served(),
                "N_excretion": self.loader_class.emissions_factors.get_ef_N_excretion_gilts_not_yet_served(),
                "bwf": self.loader_class.animal_features.get_weight_gilts_not_yet_served,
                "total_ammonia_nitrogen": self.loader_class.emissions_factors.get_ef_fracGASM_total_ammonia_nitrogen_pasture_range_paddock_deposition,
                "direct_n2o": self.loader_class.emissions_factors.get_ef3__cpp_pasture_range_paddock_sheep_direct_n2o,
                "atmospheric_deposition": self.loader_class.emissions_factors.get_ef_indirect_n2o_atmospheric_deposition_to_soils_and_water,
                "leaching": self.loader_class.emissions_factors.get_ef_indirect_n2o_from_leaching_and_runoff,
            ...
            "other_sows_for_breeding": {
                "gender": "female",
                "Gross_energy": self.loader_class.emissions_factors.get_ef_Gross_energy_other_sows_for_breeding(),
                "N_excretion": self.loader_class.emissions_factors.get_ef_N_excretion_other_sows_for_breeding(),
                "bwf": self.loader_class.animal_features.get_weight_other_sows_for_breeding,
                "total_ammonia_nitrogen": self.loader_class.emissions_factors.get_ef_fracGASM_total_ammonia_nitrogen_pasture_range_paddock_deposition,
                "direct_n2o": self.loader_class.emissions_factors.get_ef3__cpp_pasture_range_paddock_sheep_direct_n2o,
                "atmospheric_deposition": self.loader_class.emissions_factors.get_ef_indirect_n2o_atmospheric_deposition_to_soils_and_water,
                "leaching": self.loader_class.emissions_factors.get_ef_indirect_n2o_from_leaching_and_runoff,
            ...
            "pigs_under_20kg": {
                "gender": "female",
                "Gross_energy": self.loader_class.emissions_factors.get_ef_Gross_energy_pigs_under_20kg(),
                "N_excretion": self.loader_class.emissions_factors.get_ef_N_excretion_pigs_under_20kg(),
                "bwf": self.loader_class.animal_features.get_weight_pigs_under_20kg,
                "total_ammonia_nitrogen": self.loader_class.emissions_factors.get_ef_fracGASM_total_ammonia_nitrogen_pasture_range_paddock_deposition,
                "direct_n2o": self.loader_class.emissions_factors.get_ef3__cpp_pasture_range_paddock_sheep_direct_n2o,
                "atmospheric_deposition": self.loader_class.emissions_factors.get_ef_indirect_n2o_atmospheric_deposition_to_soils_and_water,
                "leaching": self.loader_class.emissions_factors.get_ef_indirect_n2o_from_leaching_and_runoff,
